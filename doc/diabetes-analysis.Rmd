...
# 2. Multi-Path AIC Procedure

We now apply the complete multi-path AIC selection pipeline:

## 2.1 Algorithm 1: Multi-Path Forward Selection
...
## 2.2 Algorithm 2: Stability Estimation
...
## 2.3 Algorithm 3: Plausible Model Selection

We filter models using AIC tolerance (Δ = 2) and stability threshold (τ = 0.6):
